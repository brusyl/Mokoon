...
function initSampleSceneGeometry() {
    ...
    var tile2 = new MOON.Tile();
    tile2.create(scene);
    
    tile2.movePosition();
*/
    
   /* var tile3 = new MOON.Tile();
    tile3.create(scene);
    
    tile3.mesh.position.x = 3.5;
    
    var tile4 = new MOON.Tile();
    tile4.create(scene);
    
    tile4.mesh.position.x = 0.85;
    tile4.mesh.position.z = 1.5;
    
    var tile5 = new MOON.Tile();
    tile5.create(scene);
	...
	if (!INTERSECTED) {
		...
		if (intersect.length > 0) {
            ...
            */
            ...
            MOON.Debug.log(INTERSECTED.character);
